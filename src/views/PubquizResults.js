...
import PubquizResults from '../components/pubquiz-results/PubquizResults';

export default function PubquizResultsView({ navigation, screenProps }) {
  ...
  return (
    <AppScreenBackground style={{ flex: 1 }}>
      ...
      <PubquizResults navigation={navigation} />
